		...
		async execute(_id, params, _signal, _update, ctx) {
			try {
				...
				if (renameTo !== undefined) {
					...
					return output({ address: params.address, rename_to: renameTo, replaced_crumpled_target: replacedCrumpledTarget });
				}
